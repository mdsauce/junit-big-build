## High CCY == Slower Tests
This is to confirm if more CCY (more tests run in parallel) == higher build durations.
...
Adjust `pom.xml` and buildTag to change Build Name and ccy.


Clone of Java-Junit-Selenium
